...
@media screen and (max-width: 575px) {
 ...
 <body>
  ...
  <div id="wrapper">
    <form id="form-login1" action="db/process_login.php" method="post">
        <h1 class="form-heading1">Form đăng nhập</h1>
        <div class="form-group1">
            <i class="far fa-user1"></i>
            <input type="text" class="form-input1" name="username" placeholder="Tên đăng nhập">
        </div>
        <div class="form-group1">
            <i class="fas fa-key1"></i>
            <input type="password" class="form-input1" name="password" placeholder="Mật khẩu">
            <div id="eye1">
                <i class="far fa-eye"></i>
            </div>
        </div>
        <input type="submit" value="Đăng nhập" class="form-submit1">
    </form>
</div>
</body>
</html>
